...
public class Partition extends UniversalActor  {
	public static void main(String args[]) {
		...
		Partition instance = (Partition)new Partition(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new Partition(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return Partition.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new Partition(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return Partition.getReferenceByLocation(new UAL(ual)); }
	public Partition(boolean o, UAN __uan)	{ super(false,__uan); }
	public Partition(boolean o, UAL __ual)	{ super(false,__ual); }
	public Partition(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Partition(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Partition(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Partition()		{  }
	public Partition(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "concurrent.Partition", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public Partition self;
		public void updateSelf(ActorReference actorReference) {
			((Partition)actorReference).setUAL(getUAL());
			((Partition)actorReference).setUAN(getUAN());
			self = new Partition(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
		...
		public State(UAN __uan, UAL __ual) {
			super(__uan, __ual);
			addClassName( "concurrent.Partition$State" );
